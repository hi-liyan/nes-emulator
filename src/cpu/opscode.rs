...
lazy_static! {
    ...
    pub static ref CPU_OPS_CODES: Vec<OpsCode> = vec![
       OpsCode::new(0x00, "BRK", 1, 7, AddressingMode::NoneAddressing), // BRK - Force Interrupt
       OpsCode::new(0xea, "NOP", 1, 2, AddressingMode::NoneAddressing), // NOP - No Operation
       ...
       OpsCode::new(0x7d, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0x79, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0x61, "ADC", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0x71, "ADC", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),
       ...
       OpsCode::new(0xfd, "SBC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0xf9, "SBC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0xe1, "SBC", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0xf1, "SBC", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),
       ...
       OpsCode::new(0x3d, "AND", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0x39, "AND", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0x21, "AND", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0x31, "AND", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),

       OpsCode::new(0x49, "EOR", 2, 2, AddressingMode::Immediate),
       OpsCode::new(0x45, "EOR", 2, 3, AddressingMode::ZeroPage),
       OpsCode::new(0x55, "EOR", 2, 4, AddressingMode::ZeroPage_X),
       OpsCode::new(0x4d, "EOR", 3, 4, AddressingMode::Absolute),
       OpsCode::new(0x5d, "EOR", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0x59, "EOR", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0x41, "EOR", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0x51, "EOR", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),

       OpsCode::new(0x09, "ORA", 2, 2, AddressingMode::Immediate),
       OpsCode::new(0x05, "ORA", 2, 3, AddressingMode::ZeroPage),
       OpsCode::new(0x15, "ORA", 2, 4, AddressingMode::ZeroPage_X),
       OpsCode::new(0x0d, "ORA", 3, 4, AddressingMode::Absolute),
       OpsCode::new(0x1d, "ORA", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0x19, "ORA", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0x01, "ORA", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0x11, "ORA", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),
       ...
       OpsCode::new(0x6a, "ROR", 1, 2, AddressingMode::Accumulator),
       OpsCode::new(0x66, "ROR", 2, 5, AddressingMode::ZeroPage),
       OpsCode::new(0x76, "ROR", 2, 6, AddressingMode::ZeroPage_X),
       OpsCode::new(0x6e, "ROR", 3, 6, AddressingMode::Absolute),
       OpsCode::new(0x7e, "ROR", 3, 7, AddressingMode::Absolute_X),
       ...
       http://www.oxyron.de/html/opcodes02.html */
        ...
        OpsCode::new(0xdF, "*DCP", 3, 7, AddressingMode::Absolute_X),
        OpsCode::new(0xdb, "*DCP", 3, 7, AddressingMode::Absolute_Y),
        OpsCode::new(0xd3, "*DCP", 2, 8, AddressingMode::Indirect_Y),
        OpsCode::new(0xc3, "*DCP", 2, 8, AddressingMode::Indirect_X),


        OpsCode::new(0x27, "*RLA", 2, 5, AddressingMode::ZeroPage),
        OpsCode::new(0x37, "*RLA", 2, 6, AddressingMode::ZeroPage_X),
        OpsCode::new(0x2F, "*RLA", 3, 6, AddressingMode::Absolute),
        OpsCode::new(0x3F, "*RLA", 3, 7, AddressingMode::Absolute_X),
        OpsCode::new(0x3b, "*RLA", 3, 7, AddressingMode::Absolute_Y),
        OpsCode::new(0x33, "*RLA", 2, 8, AddressingMode::Indirect_Y),
        OpsCode::new(0x23, "*RLA", 2, 8, AddressingMode::Indirect_X),

        OpsCode::new(0x07, "*SLO", 2, 5, AddressingMode::ZeroPage),
        OpsCode::new(0x17, "*SLO", 2, 6, AddressingMode::ZeroPage_X),
        OpsCode::new(0x0F, "*SLO", 3, 6, AddressingMode::Absolute),
        OpsCode::new(0x1f, "*SLO", 3, 7, AddressingMode::Absolute_X),
        OpsCode::new(0x1b, "*SLO", 3, 7, AddressingMode::Absolute_Y),
        OpsCode::new(0x03, "*SLO", 2, 8, AddressingMode::Indirect_X),
        OpsCode::new(0x13, "*SLO", 2, 8, AddressingMode::Indirect_Y),

        OpsCode::new(0x47, "*SRE", 2, 5, AddressingMode::ZeroPage),
        OpsCode::new(0x57, "*SRE", 2, 6, AddressingMode::ZeroPage_X),
        OpsCode::new(0x4F, "*SRE", 3, 6, AddressingMode::Absolute),
        OpsCode::new(0x5f, "*SRE", 3, 7, AddressingMode::Absolute_X),
        OpsCode::new(0x5b, "*SRE", 3, 7, AddressingMode::Absolute_Y),
        OpsCode::new(0x43, "*SRE", 2, 8, AddressingMode::Indirect_X),
        OpsCode::new(0x53, "*SRE", 2, 8, AddressingMode::Indirect_Y),


        OpsCode::new(0x80, "*NOP", 2,2, AddressingMode::Immediate),
        OpsCode::new(0x82, "*NOP", 2,2, AddressingMode::Immediate),
        OpsCode::new(0x89, "*NOP", 2,2, AddressingMode::Immediate),
        OpsCode::new(0xc2, "*NOP", 2,2, AddressingMode::Immediate),
        OpsCode::new(0xe2, "*NOP", 2,2, AddressingMode::Immediate),


        OpsCode::new(0xCB, "*AXS", 2,2, AddressingMode::Immediate),

        OpsCode::new(0x6B, "*ARR", 2,2, AddressingMode::Immediate),
        ...
        OpsCode::new(0x04, "*NOP", 2,3, AddressingMode::ZeroPage),
        OpsCode::new(0x44, "*NOP", 2,3, AddressingMode::ZeroPage),
        OpsCode::new(0x64, "*NOP", 2,3, AddressingMode::ZeroPage),
        OpsCode::new(0x14, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0x34, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0x54, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0x74, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0xd4, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0xf4, "*NOP", 2, 4, AddressingMode::ZeroPage_X),
        OpsCode::new(0x0c, "*NOP", 3, 4, AddressingMode::Absolute),
        OpsCode::new(0x1c, "*NOP", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x3c, "*NOP", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x5c, "*NOP", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x7c, "*NOP", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0xdc, "*NOP", 3, 4 /* or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0xfc, "*NOP", 3, 4 /* or 5*/, AddressingMode::Absolute_X_PageCross),

        OpsCode::new(0x67, "*RRA", 2, 5, AddressingMode::ZeroPage),
        OpsCode::new(0x77, "*RRA", 2, 6, AddressingMode::ZeroPage_X),
        OpsCode::new(0x6f, "*RRA", 3, 6, AddressingMode::Absolute),
        OpsCode::new(0x7f, "*RRA", 3, 7, AddressingMode::Absolute_X),
        OpsCode::new(0x7b, "*RRA", 3, 7, AddressingMode::Absolute_Y),
        OpsCode::new(0x63, "*RRA", 2, 8, AddressingMode::Indirect_X),
        OpsCode::new(0x73, "*RRA", 2, 8, AddressingMode::Indirect_Y),


        OpsCode::new(0xe7, "*ISB", 2,5, AddressingMode::ZeroPage),
        OpsCode::new(0xf7, "*ISB", 2,6, AddressingMode::ZeroPage_X),
        OpsCode::new(0xef, "*ISB", 3,6, AddressingMode::Absolute),
        OpsCode::new(0xff, "*ISB", 3,7, AddressingMode::Absolute_X),
        OpsCode::new(0xfb, "*ISB", 3,7, AddressingMode::Absolute_Y),
        ...
        OpsCode::new(0x5a, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpsCode::new(0x7a, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpsCode::new(0xda, "*NOP", 1,2, AddressingMode::NoneAddressing),
        ...
        OpsCode::new(0x9f, "*AHX", 3, /* guess */ 4/* or 5*/, AddressingMode::Absolute_Y_PageCross), //todo: highly unstable and not used
        OpsCode::new(0x9e, "*SHX", 3, /* guess */ 4/* or 5*/, AddressingMode::Absolute_Y_PageCross), //todo: highly unstable and not used
        OpsCode::new(0x9c, "*SHY", 3, /* guess */ 4/* or 5*/, AddressingMode::Absolute_X_PageCross), //todo: highly unstable and not used

        OpsCode::new(0xa7, "*LAX", 2, 3, AddressingMode::ZeroPage),
        OpsCode::new(0xb7, "*LAX", 2, 4, AddressingMode::ZeroPage_Y),
        OpsCode::new(0xaf, "*LAX", 3, 4, AddressingMode::Absolute),
        OpsCode::new(0xbf, "*LAX", 3, 4, AddressingMode::Absolute_Y_PageCross),
        OpsCode::new(0xa3, "*LAX", 2, 6, AddressingMode::Indirect_X),
        OpsCode::new(0xb3, "*LAX", 2, 5, AddressingMode::Indirect_Y_PageCross),

        OpsCode::new(0x87, "*SAX", 2, 3, AddressingMode::ZeroPage),
        OpsCode::new(0x97, "*SAX", 2, 4, AddressingMode::ZeroPage_Y),
        OpsCode::new(0x8f, "*SAX", 3, 4, AddressingMode::Absolute),
        OpsCode::new(0x83, "*SAX", 2, 6, AddressingMode::Indirect_X),
       ...
       OpsCode::new(0xcd, "CMP", 3, 4, AddressingMode::Absolute),
       OpsCode::new(0xdd, "CMP", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X_PageCross),
       OpsCode::new(0xd9, "CMP", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y_PageCross),
       OpsCode::new(0xc1, "CMP", 2, 6, AddressingMode::Indirect_X),
       OpsCode::new(0xd1, "CMP", 2, 5/*+1 if page crossed*/, AddressingMode::Indirect_Y_PageCross),
       ...
       OpsCode::new(0x70, "BVS", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing),
       OpsCode::new(0x50, "BVC", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing),
       OpsCode::new(0x30, "BMI", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing),
       ...
       OpsCode::new(0x2c, "BIT", 3, 4, AddressingMode::Absolute),
